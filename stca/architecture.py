...
Define architecture rules in .stca.yaml:
    architecture:
      layers:
        - name: controllers
...
Then STCA flags any import that violates the layer hierarchy:
...
# Default architecture rules (can be overridden in .stca.yaml)
