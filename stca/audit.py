"""Audit log system — tamper-evident logging of all STCA actions.

Enterprise feature: every STCA action (check, fix, review, config change)
...
class AuditLogger:
    """Tamper-evident audit logger for STCA."""
