...
def find_function_pairs(file_path: Path) -> List[Tuple[str, str]]:
    ...
    Heuristics:
      ...
      - Functions marked with @stca.differential("ref") and @stca.differential("impl")
...
def run_differential_tests(file_path: Path,
    ...
    test_file = (repo_root or file_path.parent) / ".stca-cache" / "differential" / f"test_{file_path.stem}_diff.py"
