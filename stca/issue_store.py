...
This enables:
  - `stca trend` — show issues found/fixed over time
  - `stca issue list --state open` — list open issues
  - `stca issue resolve <id>` — mark as fixed/wontfix
